...
export { chipText, elssHeadline, mfChipText, mfHeadline, mfRedeemHeadline, MF_CHARGES_NOTE, MF_DEBT_NOTE, redemptionText, GAIN_HARVEST_NOTE, KEEP_CONTRAST, KEEP_NOTE, KEEP_TITLE, lossPanel, POSITIONING, profitTakeaway, UPSTOX_TLH_URL, waitPanel } from './copy'
